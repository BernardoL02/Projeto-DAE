...
/*public class ResSensorDetalhesDTO implements Serializable {
    ...
    public ResSensorDetalhesDTO(int id, String valor, String tipoNome, String estado, int bateria, LocalDateTime timeStamp) {
        this.id = id;
        this.valor = valor;
    ...
    public static ResSensorDetalhesDTO from(Sensor sensor) {
        return new ResSensorDetalhesDTO(
                sensor.getId(),
                sensor.getValor(),
