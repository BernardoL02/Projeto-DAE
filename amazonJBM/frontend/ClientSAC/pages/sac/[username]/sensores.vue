...
<template>
    ...
    <div class="flex justify-between items-center ml-28 mr-28 mt-20">
      ...
      <div class="w-64">
        <select v-model="selectedTipo" name="Sensores" id="sensores" class="block w-full p-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-SecundaryColor focus:border-SecundaryColor text-gray-700">
