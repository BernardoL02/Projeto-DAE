    ...
    <div class="flex flex-col justify-center w-[405px]">
      ...
      >
        <div class="flex flex-row space-x-4 relative">
          ...
          >
            <img
              src="../../public/Images/produtos.png"
              alt="Ícone de Embalagens"
              class="w-7 h-7"
            />
          </div>
        </div>
    ...
    <div class="flex flex-col justify-center pr-28 w-[520px]">
      ...
      >
        <div class="flex flex-row space-x-4 relative">
          ...
          >
            <img
              src="../../public/Images/embalagem.png"
              alt="Ícone de Embalagens"
              class="w-8 h-8"
            />
          </div>
        ...
        >
          ...
          >
            ...
            <!-- Grid de cartões -->
            <div
              class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 max-w-2xl"
            >
              <div
        ...
        >
          <div class="bg-white w-1/2 p-6 rounded shadow-lg relative">
            ...
            <form @submit.prevent="criarEmbalagem" class="space-y-4">
              ...
              <div>
                <label for="tipo" class="block font-medium"
                  >Id do Tipo da Embalagem</label
                >
                <input
                  id="tipo"
                  v-model="novoTipoEmbalagem.id"
                  type="text"
                  class="w-full border border-gray-300 p-2 rounded"
                  placeholder="Escreva id do tipo da embalagem"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  class="w-full border border-gray-300 p-2 rounded"
                  placeholder="Escreva o tipo da embalagem"
                />
              </div>
